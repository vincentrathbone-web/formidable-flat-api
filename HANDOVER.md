...
- Joins-only query (no source tables, two saved queries combined purely via step 1b) — verify save, live preview, and that the resulting saved query actually runs (not just previews) via REST/export
